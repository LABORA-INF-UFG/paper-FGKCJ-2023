...
public class Sim_teste {
	
	private static final double sc0_R = 20;
	private static final double sc0_T = 20;
	private static final double sc1_R = 20;
	private static final double sc1_T = 20;
	private static final double sc2_R = 20;
	private static final double sc2_T = 20;
	private static final double sc3_R = 20;
	private static final double sc3_T = 20;
	private static final double ac_r_0 = 5;
	private static final double ac_b_0 = 25;
	private static final double ac_r_1 = 5;
	private static final double ac_b_1 = 25;
...
//	private static int N_x=1; //Qtde de fluxos embb
	private static int N_server=4; // Quantidade de servidores
	...
	//Curva de Serviço
		...
		private	static ServiceCurve sc_3 = CurvePwAffine.getFactory().createRateLatency(sc3_R,sc3_T);
...
//		network.addLink(s0, s1);
		...
		for (int i=0;i<N_e;i++) {
				flow_e[i] = network.addFlow(ac_e, s[1], s[2]);
		}
