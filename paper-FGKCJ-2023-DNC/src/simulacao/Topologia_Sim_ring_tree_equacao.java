...
public class Topologia_Sim_ring_tree_equacao {
	
	private static final double sc_R_s = 20;
	private static final double sc_T_s = 5;
	private static final double sc_R_t = 20;
	private static final double sc_T_t = 5;
	private static final double sc_R_u = 20;
	private static final double sc_T_u = 5;
	private static final double ac_r_0 = 2;
