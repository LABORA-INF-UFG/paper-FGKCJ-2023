...
public class Sim_3S {
	...
	public static void rede_tfa_sfa() throws Exception {
		...
		Flow flow1 = network.addFlow(ac1, s0, s2);
		Flow flow2 = network.addFlow(ac2, s0, s2);
...
//	      }   
		...
		Flow flow1 = network.addFlow(ac1, s0, s2); // De s0 até s1, ou seja, inicio e fim (ex: s0,s2)
		Flow flow2 = network.addFlow(ac2, s0, s2);
