...
public class Topologia_Sim {
	...
	private static int N_server=3; // Quantidade de servidores
	private static boolean print_all=true;
	//Curva de Serviço
		private	static ServiceCurve sc = CurvePwAffine.getFactory().createRateLatency(sc_R,sc_T);
			//Curva de Chegada
